...
public class MainActivity extends AppCompatActivity {
    ...
    EditText editName, editEmail, editPassword, editPhone, editRole, editAccountStatus;
            ...
            public void onComplete(@NonNull Task<DataSnapshot> task) {
                if (task.isSuccessful()) {
                    if (task.getResult().exists()) {
                        ...
                        Toast.makeText(MainActivity.this, "Result not exist", Toast.LENGTH_SHORT).show();
                    }
                }
            }
        });
