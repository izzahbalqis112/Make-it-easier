...
import ftmk.bitp3453.authenticationapp.firebase.EnrollCourseAdapter;
...
public class StudentEnrollActivity extends AppCompatActivity {
    ...
    EnrollCourseAdapter adapterCourse;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnBack.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(StudentEnrollActivity.this, StudentSubjectMenu.class);
        ...
        adapterCourse = new EnrollCourseAdapter(StudentEnrollActivity.this, courseList);
        ...
        db.collection("Course").orderBy("course_name", Query.Direction.ASCENDING).get()
                .addOnCompleteListener(new OnCompleteListener<QuerySnapshot>() {
                    ...
                    public void onFailure(@NonNull Exception e) {
                        Toast.makeText(StudentEnrollActivity.this, "Opps", Toast.LENGTH_SHORT).show();
                    }
                });
