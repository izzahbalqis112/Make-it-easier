...
public class ViewLecturerEnrollSubject extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnBack.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(ViewLecturerEnrollSubject.this,LecturerSubjectMenu.class);
        ...
        adapter = new EnrollSubjectAdapter(ViewLecturerEnrollSubject.this,list);
        ...
        db.collection("Lecturer_Enroll")
                ...
                .addOnCompleteListener(new OnCompleteListener<QuerySnapshot>() {
                    ...
                    public void onFailure(@NonNull Exception e) {
                        Toast.makeText(ViewLecturerEnrollSubject.this, "Opps", Toast.LENGTH_SHORT).show();
                    }
                });
